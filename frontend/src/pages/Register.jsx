    ...
    <div className="min-h-screen bg-darkBg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="w-12 h-12 rounded-2xl bg-accent-gradient flex items-center justify-center text-darkBg mb-3 shadow-accent-glow">
            <Music className="w-6 h-6 fill-current" />
          </div>
          <h2 className="text-2xl font-bold text-white">Create Account</h2>
          <p className="text-textSecondary text-sm mt-0.5">Start scanning your emotions for playlists</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-textSecondary mb-1.5 uppercase tracking-wider">Full Name</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-2.5 bg-white/5 border border-white/5 focus:border-primaryAccent focus:ring-1 focus:ring-primaryAccent rounded-xl text-sm text-white placeholder-textSecondary/50 outline-none transition-all"
          ...
          {/* Email Input */}
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-textSecondary mb-1.5 uppercase tracking-wider">Email Address</label>
            <div className="relative">
          ...
          {/* Password Input */}
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-textSecondary mb-1.5 uppercase tracking-wider">Password</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-2.5 bg-white/5 border border-white/5 focus:border-primaryAccent focus:ring-1 focus:ring-primaryAccent rounded-xl text-sm text-white placeholder-textSecondary/50 outline-none transition-all"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-textSecondary mb-1.5 uppercase tracking-wider">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-textSecondary" />
              <input
                type={showPassword ? 'text' : 'password'}
        ...
        <p className="text-center text-textSecondary text-xs mt-6">
          ...
          <Link to="/login" className="text-primaryAccent font-semibold hover:underline">
            Sign In
          </Link>
        </p>
      </motion.div>
